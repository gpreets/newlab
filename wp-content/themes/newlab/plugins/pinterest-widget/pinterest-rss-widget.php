...
function add_pinterest_rss_css() {
	...
	$pinterest_rss_myStyleFile = WP_PLUGIN_DIR . '/pinterest-widget/style.css';
		...
		include_once(ABSPATH . WPINC . '/feed.php');
				...
				// Loop through each feed item and display each item as a hyperlink.
				  foreach ( $rss_items as $item ) :
					$content .= '<li class="pins-feed-item" style="width:'. $thumbwidth .';height:'. $thumbheight .';">';
...
add_action( 'widgets_init', create_function('', 'return register_widget("Pinterest_Widget");') );
